...
//  CupcakeCorner
//
//  Created by Anthony Candelino on 2024-08-23.
//
...
struct CheckoutView: View {
    ...
    var body: some View {
        ...
        .alert("Error placing order", isPresented: $hasCheckoutFailed) {
            Button("Ok") {
                hasCheckoutFailed = false
            }
        }
        .onAppear {
            order.saveAddress()
    ...
    func placeOrder() async {
        ...
        let url = URL(string: "https://reqres.in/api/cupcakes")! // ! forces unwrap of optional returned from URL()
